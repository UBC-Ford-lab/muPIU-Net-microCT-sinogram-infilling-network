#!/usr/bin/env python3
"""
MAT MTF/NPS/NEQ Metric Calculator
==================================
This script calculates MTF, NPS, and NEQ metrics for MAT reconstruction
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description='Calculate MTF/NPS/NEQ metrics for MAT reconstruction'
    )
...
def main():
    """Main function to calculate all metrics for MAT."""

    args = parse_args()

    print("="*70)
    print("MAT MTF/NPS/NEQ Metric Calculator")
    print("="*70)
    ...
    # Create individual plots for MAT only
    print("\n" + "="*60)
    print("Creating individual plots for MAT...")
    print("="*60)

    # Load MAT data again for individual plots
    header, mat_data = vff.read_vff(str(vff_files[1]), verbose=False)
    create_individual_plots(
        mat_data, "MAT", output_dir, pixel_size,
        mtf_slice_range, crop_indices_MTF, edge_angle,
        nps_slice_range, ROI_bounds_NPS
    )
