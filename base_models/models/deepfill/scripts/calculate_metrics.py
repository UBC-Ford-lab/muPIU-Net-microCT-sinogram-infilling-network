#!/usr/bin/env python3
"""
DeepFill v2 MTF/NPS/NEQ Metric Calculator
==========================================
This script calculates MTF, NPS, and NEQ metrics for DeepFill v2 reconstruction
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description='Calculate MTF/NPS/NEQ metrics for DeepFill v2 reconstruction'
    )
...
def main():
    """Main function to calculate all metrics for DeepFill v2."""

    args = parse_args()

    print("="*70)
    print("DeepFill v2 MTF/NPS/NEQ Metric Calculator")
    print("="*70)
    ...
    # Create individual plots for DeepFill only
    print("\n" + "="*60)
    print("Creating individual plots for DeepFill v2...")
    print("="*60)

    # Load DeepFill data again for individual plots
    header, deepfill_data = vff.read_vff(str(vff_files[1]), verbose=False)
    create_individual_plots(
        deepfill_data, "DeepFill v2", output_dir, pixel_size,
        mtf_slice_range, crop_indices_MTF, edge_angle,
        nps_slice_range, ROI_bounds_NPS
    )
