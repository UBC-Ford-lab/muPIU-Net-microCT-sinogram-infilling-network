#!/usr/bin/env python3
"""
LaMa MTF/NPS/NEQ Metric Calculator
===================================
This script calculates MTF, NPS, and NEQ metrics for LaMa reconstruction
...
def main():
    ...
    # Create individual plots for LaMa only
    print("\n" + "="*60)
    print("Creating individual plots for LaMa...")
    print("="*60)
